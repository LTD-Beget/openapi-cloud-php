 ...
 */
class MysqlMysql5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Mysql_Mysql5';
    ...
    protected static $openAPITypes = [
        'configuration' => '\OpenAPI\Client\Model\MysqlMysql5Configuration',
        'host' => 'string',
        'port' => 'int',
    ...
    */
     ...
     * Sets configuration
     *
     * @param \OpenAPI\Client\Model\MysqlMysql5Configuration|null $configuration configuration
     *
     * @return self
     */
