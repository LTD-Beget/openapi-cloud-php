...
/**
 * PostgresqlPgUpdateRemoteAccessRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostgresqlPgUpdateRemoteAccessRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Postgresql_PgUpdateRemoteAccessRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('subnet_address', $data ?? [], null);
    }
    ...
    */
    ...
    public function setSubnetAddress($subnet_address)
    {
        ...
        if (is_null($subnet_address)) {
            throw new \InvalidArgumentException('non-nullable subnet_address cannot be null');
        }
