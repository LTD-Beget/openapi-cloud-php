...
/**
 * MysqlMysql84 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MysqlMysql84 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Mysql_Mysql84';
    ...
    protected static $openAPITypes = [
        'configuration' => '\OpenAPI\Client\Model\MysqlMysql84Configuration',
        'host' => 'string',
        'port' => 'int',
    ...
    */
     ...
     * Sets configuration
     *
     * @param \OpenAPI\Client\Model\MysqlMysql84Configuration|null $configuration configuration
     *
     * @return self
     */
