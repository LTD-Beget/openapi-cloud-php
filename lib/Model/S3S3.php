...
class S3S3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'attached_cdn' => '\OpenAPI\Client\Model\S3S3Cdn'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('attached_cdn', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets attached_cdn
     *
     * @return \OpenAPI\Client\Model\S3S3Cdn|null
     */
    public function getAttachedCdn()
    {
        return $this->container['attached_cdn'];
    }

    /**
     * Sets attached_cdn
     *
     * @param \OpenAPI\Client\Model\S3S3Cdn|null $attached_cdn attached_cdn
     *
     * @return self
     */
    public function setAttachedCdn($attached_cdn)
    {
        if (is_null($attached_cdn)) {
            throw new \InvalidArgumentException('non-nullable attached_cdn cannot be null');
        }
        $this->container['attached_cdn'] = $attached_cdn;
