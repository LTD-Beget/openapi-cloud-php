...
/**
 * StructuresPostgresqlCopy Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StructuresPostgresqlCopy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Structures_PostgresqlCopy';
    ...
    public const VERSION_POSTGRESQL14 = 'POSTGRESQL14';
    public const VERSION_POSTGRESQL15 = 'POSTGRESQL15';
    public const VERSION_POSTGRESQL164 = 'POSTGRESQL164';
    ...
    {
        return [
            self::VERSION_POSTGRESQL14,
            self::VERSION_POSTGRESQL15,
            self::VERSION_POSTGRESQL164,
        ];
    }
