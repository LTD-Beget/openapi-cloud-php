...
/**
 * CdnSettingsIpAddressAcl Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CdnSettingsIpAddressAcl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cdn_Settings_IpAddressAcl';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('excepted_ip', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string[]|null
     */
    public function getExceptedIp()
    {
        return $this->container['excepted_ip'];
    }

    /**
     * Sets excepted_ip
     *
     * @param string[]|null $excepted_ip excepted_ip
     *
     * @return self
     */
    public function setExceptedIp($excepted_ip)
    {

        if (is_null($excepted_ip)) {
            throw new \InvalidArgumentException('non-nullable excepted_ip cannot be null');
        }

        $this->container['excepted_ip'] = $excepted_ip;
