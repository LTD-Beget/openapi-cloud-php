...
class S3Cors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('http_header', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['http_header'];
    }

    /**
     * Sets http_header
     *
     * @param string[]|null $http_header http_header
     *
     * @return self
     */
    public function setHttpHeader($http_header)
    {
        ...
        if (is_null($http_header)) {
            throw new \InvalidArgumentException('non-nullable http_header cannot be null');
        }

        $this->container['http_header'] = $http_header;
