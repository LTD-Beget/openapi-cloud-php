...
/**
 * CdnChangeResourceDomainsResponseDomainErrorDomainAlreadyUsedDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CdnChangeResourceDomainsResponseDomainErrorDomainAlreadyUsedDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cdn_ChangeResourceDomainsResponse_DomainError_DomainAlreadyUsedDetails';
    ...
    public const SERVICE_TYPE_UNDERSCORE = '_';
    public const SERVICE_TYPE_CLOUD = 'CLOUD';
    ...
    {
        return [
            self::SERVICE_TYPE_UNDERSCORE,
            self::SERVICE_TYPE_CLOUD,
        ];
    }
