...
/**
 * PostgresqlPostgresql15 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostgresqlPostgresql15 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Postgresql_Postgresql15';
    ...
    protected static $openAPITypes = [
        'configuration' => '\OpenAPI\Client\Model\PostgresqlPostgresql15Configuration',
        'host' => 'string',
        'port' => 'int',
    ...
    */
     ...
     * Sets configuration
     *
     * @param \OpenAPI\Client\Model\PostgresqlPostgresql15Configuration|null $configuration configuration
     *
     * @return self
     */
