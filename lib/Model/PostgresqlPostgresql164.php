...
/**
 * PostgresqlPostgresql164 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostgresqlPostgresql164 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Postgresql_Postgresql164';
    ...
    protected static $openAPITypes = [
        'configuration' => '\OpenAPI\Client\Model\PostgresqlPostgresql164Configuration',
        'host' => 'string',
        'port' => 'int',
    ...
    */
     ...
     * Sets configuration
     *
     * @param \OpenAPI\Client\Model\PostgresqlPostgresql164Configuration|null $configuration configuration
     *
     * @return self
     */
