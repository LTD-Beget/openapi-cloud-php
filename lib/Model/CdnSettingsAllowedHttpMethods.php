...
/**
 * CdnSettingsAllowedHttpMethods Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CdnSettingsAllowedHttpMethods implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cdn_Settings_AllowedHttpMethods';
    ...
    */
    ...
    public function setHttpMethod($http_method)
    {
        ...
        if (!is_null($http_method) && array_diff($http_method, $allowedValues)) {
