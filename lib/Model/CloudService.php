...
class CloudService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'network_drive' => '\OpenAPI\Client\Model\NetworkDriveNetworkDrive',
        'manage_enabled' => 'bool',
        'slug' => 'string',
    ...
    public const TYPE_NETWORK_DRIVE = 'NETWORK_DRIVE';
    ...
    */
    ...
    public function setStatusDetails($status_details)
    {
        ...
        $allowedValues = $this->getStatusDetailsAllowableValues();
        if (!in_array($status_details, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'status_details', must be one of '%s'",
                    $status_details,
     ...
     * Gets network_drive
     *
     * @return \OpenAPI\Client\Model\NetworkDriveNetworkDrive|null
     */
     ...
     * Sets network_drive
     *
     * @param \OpenAPI\Client\Model\NetworkDriveNetworkDrive|null $network_drive network_drive
     *
     * @return self
     */
