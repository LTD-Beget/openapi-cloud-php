...
/**
    ...
    public function cloudServiceBindProjectRequest($service_id, $cloud_bind_project_request, string $contentType = self::contentTypes['cloudServiceBindProject'][0])
    {
        ...
        if (isset($cloud_bind_project_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cloud_bind_project_request));
            } else {
    ...
    public function cloudServiceChangeConfigurationRequest($service_id, $cloud_change_configuration_request, string $contentType = self::contentTypes['cloudServiceChangeConfiguration'][0])
    {
        ...
        if (isset($cloud_change_configuration_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cloud_change_configuration_request));
            } else {
    ...
    public function cloudServiceChangePinnedRequest($service_id, $cloud_change_pinned_request, string $contentType = self::contentTypes['cloudServiceChangePinned'][0])
    {
        ...
        if (isset($cloud_change_pinned_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cloud_change_pinned_request));
            } else {
    ...
    public function cloudServiceCreateRequest($cloud_create_request, string $contentType = self::contentTypes['cloudServiceCreate'][0])
    {
        ...
        if (isset($cloud_create_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cloud_create_request));
            } else {
    ...
    public function cloudServiceUpdateRequest($service_id, $cloud_update_request, string $contentType = self::contentTypes['cloudServiceUpdate'][0])
    {
        ...
        if (isset($cloud_update_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cloud_update_request));
            } else {
